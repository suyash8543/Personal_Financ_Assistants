                ...
                <form onSubmit={handleSubmit}>
                    <div className="form-group">
                        ...
                        <div className="input-icon-wrapper">
                            <svg className="input-icon" width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="#94A3B8" strokeWidth="2"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2" /><circle cx="12" cy="7" r="4" /></svg>
